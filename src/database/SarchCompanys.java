 ...
 * @author hp
 */
public class SarchCompanys extends javax.swing.JFrame {

    /**
     * Creates new form SarchExort
     */
    public SarchCompanys() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton16.setText("اضافة قضية تصفية");
        ...
        jLabel1.setText("البحث في مصفي الشركات");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SarchExort.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SarchExort().setVisible(true);
            }
        });
    }
