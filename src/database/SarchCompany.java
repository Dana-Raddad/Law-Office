 ...
 * @author hp
 */
public class SarchCompany extends javax.swing.JFrame {

    /**
     * Creates new form SarchCompany
     */
    public SarchCompany() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "______", "اسم المصفي", "رقم القضية", "موضوع الدعوى" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SarchCompany.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SarchCompany().setVisible(true);
            }
        });
    }
